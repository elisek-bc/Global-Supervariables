    ...
    <div class="wrapper">
        <div class="row m-auto">
            <div class="col roulette">
                ...
                // 4. create if statement to change something in array items 20 % chance
                    $randomNum = rand(1,5);
                    echo "<h3>You guessed $randomNum</h3>";
        ...
        <div class="row m-3 text-center">
            <div class="col-3">
                ...
                <pre>
                    ...
                    //11. Find a way to print this final object on the homepage, in an easily readable way
                        echo "<h3> Mutated arrays</h3><div class='line'></div>";
                        print_r($fruits);
            ...
            <div class="col-3">
                <pre>
                    <?php
                        echo "<h3> Splitted array </h3><div class='line'></div>";
                        print_r($fruits1);
                        print_r($fruits2);
                    ?>
                </pre>
            ...
            <div class="col-6">
                <pre>
                    <?php 
                        echo "<h3>My Cookie:</h3><div class='line'></div>";
